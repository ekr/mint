...
func TestDHNegotiation(t *testing.T) {
	...
	// Test successful negotiation
	ok, group, pub, secret := DHNegotiation(keyShares, []NamedGroup{X25519}, true)
	assertEquals(t, ok, true)
	...
	ok, group, pub, secret = DHNegotiation(badKeyShares, []NamedGroup{P256, X25519}, true)
	assertEquals(t, ok, false)
	prng = originalPRNG
	...
	// Test failure
	ok, _, _, _ = DHNegotiation(keyShares, []NamedGroup{P521}, true)
	assertEquals(t, ok, false)
}
