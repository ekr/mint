...
// This value is generated by the firewall beforehand and sent to the client. Abstracted away in this
// implementation.
var z,_ = rand.Int(prng, bn256.Order) // Not known by the client
var g2 bn256.G2 // Create G2 struct
var hz = g2.ScalarBaseMult(z) // Sent to the client
...
func newKeyShare(group NamedGroup) (pub []byte, priv []byte, err error) {
	...
	// spearmint: Add new case for pairing-friendly curves here. Also, will be different for client and server.

	//case BN256:
	//	var private [64]byte, public [128]byte
	//	_, err =
	//
	//
